...
//     * */
//    @RequestMapping(value = "/limit/{caseNumber}",method = RequestMethod.PUT)
...
////    public Result toothSetBySupervisor(@PathVariable("caseNumber") String caseNumber,@PathVariable("mechanicId") int mechanicId) {
////        return new Result();
////    }
//
//    /*
